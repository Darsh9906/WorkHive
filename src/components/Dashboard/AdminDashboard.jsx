      ...
      <main className="flex-1 h-screen overflow-y-auto p-6 md:p-8 max-w-7xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mt-6">
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4">
              <div className="text-2xl font-bold text-slate-900">{totalNew}</div>
              <p className="text-xs text-slate-500 mt-1">Pending employee pickup</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-slate-500 mt-1">In-progress deliverables</p>
            </div>
          </div>
          ...
          <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs flex flex-col justify-between">
            ...
            <div className="mt-4">
              ...
              <p className="text-xs text-slate-500 mt-1">Finished tasks</p>
            </div>
          </div>
        </div>
