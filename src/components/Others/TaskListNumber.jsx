    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4 mt-4 sm:mt-6">
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors">
        ...
        <div className="mt-3 sm:mt-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Pending acceptance</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl p-4 sm:p-5 shadow-xs flex flex-col justify-between transition-colors">
        ...
        <div className="mt-3 sm:mt-4">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">Currently in progress</p>
        </div>
      </div>
