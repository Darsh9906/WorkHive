    ...
    <div className="bg-white border border-slate-200 rounded-xl p-5 shadow-xs hover:border-slate-300 hover:shadow-md transition-all duration-200 flex flex-col justify-between min-h-[230px]">
      <div>
        <div className="flex items-center justify-between gap-2 mb-3">
          ...
          <span className="bg-emerald-50 text-emerald-700 border border-emerald-200 px-2 py-0.5 rounded-md text-[11px] font-semibold flex items-center gap-1">
      ...
      <div className="mt-5 pt-3 border-t border-slate-100 flex flex-col gap-3">
        ...
        <div className="w-full bg-emerald-50 text-emerald-700 border border-emerald-200 py-1.5 px-3 rounded-lg text-xs font-medium text-center flex items-center justify-center gap-1.5">
